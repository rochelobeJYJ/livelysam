...
$target = Join-Path $workspace "dist\screenplay\LivelySam"
...
Copy-Item -LiteralPath (Join-Path $workspace "SCREENPLAY_SETUP.md") -Destination $target
...
Write-Output "ScreenPlay package created at:"
Write-Output $target
